                    ...
                    <div class="card table-card">
                        <div class="card-header table-header">
                            <div class="title-with-breadcrumb">
                                <div class="table-title">Edit Sale</div>
                                ...
                                <table class="table table-bordered" id="sale-items">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" class="form-control custom-input price" name="prices[]" value="{{ $item->unit_price }}" readonly></td>
                                            <td><input type="number" class="form-control custom-input qty" name="quantities[]" min="1" value="{{ $item->quantity }}"></td>
                                            <td><input type="number" class="form-control custom-input total" name="totals[]" value="{{ $item->total_price }}" readonly></td>
                            ...
                            <div class="card table-card">
                                ...
                                <div class="custom-form card-body">
                                    <div class="mb-2">
                                        ...
                                        <input type="number" name="subtotal" id="subtotal" class="form-control custom-input" value="{{ $sale->subtotal }}" readonly>
                                    </div>
                                    <div class="mb-2">
                                        <label class="custom-label">Discount (flat amount - tk)</label>
                                        <input type="number" name="discount" id="discount" class="form-control custom-input" value="{{ $sale->discount }}">
                                    </div>
                                    <div class="mb-2">
                                        <label class="custom-label">VAT (5% - tk)</label>
                                        <input type="number" name="vat" id="vat" class="form-control custom-input" value="{{ $sale->vat }}" readonly>
                                    </div>
                                    <div class="mb-2">
                                        <label class="custom-label">Total (tk)</label>
                                        <input type="number" name="total" id="total" class="form-control custom-input" value="{{ $sale->total }}" readonly>
                                    </div>
                                    <div class="mb-2">
                                        <label class="custom-label">Paid (tk)</label>
                                        <input type="number" name="paid" id="paid" class="form-control custom-input" value="{{ $sale->paid }}">
                                    </div>
                                    <div class="mb-2">
                                        <label class="custom-label">Due (tk)</label>
                                        <input type="number" name="due" id="due" class="form-control custom-input" value="{{ $sale->due }}" readonly>
                                    </div>
