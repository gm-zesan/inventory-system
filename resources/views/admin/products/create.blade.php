                    ...
                    <div class="card-body custom-form">
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control custom-input" name="name" placeholder="Product Name" value="{{ old('name') }}">
                                @error('name')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control custom-input" name="purchase_price" placeholder="Purchase Price" step="0.01" value="{{ old('purchase_price') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control custom-input" name="sell_price" placeholder="Sell Price" step="0.01" value="{{ old('sell_price') }}">
                                @error('sell_price')
                                    <div class="error_msg">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                <label for="stock" class="form-label custom-label">Opening Stock</label>
                                <input type="number" class="form-control custom-input" name="stock" placeholder="Stock Quantity" value="{{ old('stock') }}">
                                @error('stock')
                                    <div class="error_msg">{{ $message }}</div>
                                @enderror
                            </div>
